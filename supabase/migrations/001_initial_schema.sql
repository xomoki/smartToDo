...
CREATE INDEX idx_tasks_source_external ON tasks(source_system, external_id);
...
CREATE INDEX idx_time_logs_date ON task_time_logs(date);
...
CREATE INDEX idx_ai_learning_org_id ON ai_learning_data(organization_id);
CREATE INDEX idx_ai_learning_user_id ON ai_learning_data(user_id);
CREATE INDEX idx_ai_learning_created_at ON ai_learning_data(created_at);
